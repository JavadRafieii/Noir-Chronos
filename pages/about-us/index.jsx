...
function AboutUsPage() {
    return (
        <>
            <figure className="relative">
                ...
                <figcaption className="w-full h-full absolute bg-[#0000008a] left-0 top-0 flex items-center justify-center">
                    <div className="w-full sm:w-2/3 lg:w-1/3 px-5">
                        <h4 className="font-Sacramento-Regular text-4xl sm:text-5xl lg:text-6xl text-golden text-center">Our Story</h4>
                        <p className="font-Roboto-Bold text-white text-xl text-center my-3 sm:my-4 lg:my-5">
            ...
            <Container>
                <div className="py-10">
                    <span className="block font-Roboto-Light text-xl text-light-gray text-center">WELCOME TO NOIR CHRONOS</span>
                    <h2 className="font-Roboto-Bold text-3xl sm:text-4xl lg:text-5xl text-white text-center leading-[3rem] sm:leading-[3.5rem] lg:leading-[4rem] my-3 sm:my-4 lg:my-5">ONE STORE. SINCE 1930</h2>
                    <p className="font-Roboto-Medium text-light-gray text-base text-center lg:w-3/4 mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-10 pb-20">
                    <div>
                        <div className="h-full flex flex-col justify-center items-start gap-5">
                            <h3 className="font-Roboto-Bold text-white text-3xl xl:text-4xl">Beyond the Game</h3>
                            <p className="font-Roboto-Medium text-light-gray text-base">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5 lg:gap-10 py-10">
                    ...
                    <div>
                        <div className="h-full flex flex-col justify-center items-start gap-5">
                            <h3 className="font-Roboto-Bold text-white text-3xl xl:text-4xl">Future Goals</h3>
                            <p className="font-Roboto-Medium text-light-gray text-base">
